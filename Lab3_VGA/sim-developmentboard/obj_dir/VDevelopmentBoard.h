...
VL_MODULE(VDevelopmentBoard) {
  public:
    ...
    CData/*0:0*/ DevelopmentBoard__DOT__vga_colorbar_inst__DOT__pll_inst__DOT__clk_25;
    SData/*9:0*/ DevelopmentBoard__DOT__vga_colorbar_inst__DOT__pix_x;
    SData/*15:0*/ DevelopmentBoard__DOT__vga_colorbar_inst__DOT__pix_data;
    SData/*9:0*/ DevelopmentBoard__DOT__vga_colorbar_inst__DOT__vga_ctrl_inst__DOT__cnt_h;
    SData/*9:0*/ DevelopmentBoard__DOT__vga_colorbar_inst__DOT__vga_ctrl_inst__DOT__cnt_v;
    
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    CData/*0:0*/ __VinpClk__TOP__DevelopmentBoard__DOT__vga_colorbar_inst__DOT__pll_inst__DOT__clk_25;
    CData/*0:0*/ __Vclklast__TOP__clk;
    CData/*0:0*/ __Vclklast__TOP__reset;
    CData/*0:0*/ __Vclklast__TOP____VinpClk__TOP__DevelopmentBoard__DOT__vga_colorbar_inst__DOT__pll_inst__DOT__clk_25;
    CData/*0:0*/ __Vchglast__TOP__DevelopmentBoard__DOT__vga_colorbar_inst__DOT__pll_inst__DOT__clk_25;
