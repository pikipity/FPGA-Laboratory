...
module tb_vga_pic_move_ball_wrong_click_ok_simulation();
...
initial begin
    $dumpfile("signals_tb_vga_pic_move_ball_wrong_click_ok_simulation.vcd");
    $dumpvars(0, tb_vga_pic_move_ball_wrong_click_ok_simulation);
end
